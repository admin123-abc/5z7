...
GUI_WINDOW_W:     int  = 1680          # 窗口总宽度（含侧边栏）
GUI_WINDOW_H:     int  = 1280          # 窗口高度
GUI_FPS:          int  = 60           # 渲染帧率

# ── 棋盘布局 ─────────────────────────────────────────────────
GUI_BOARD_MARGIN: int  = 40           # 棋盘边距（像素），留给行列号
GUI_SIDE_PANEL_W: int  = 440          # 右侧信息面板宽度（扩大以容纳双舱 UI）
...
# ============================================================
#  DeepSeek 配置（猫娘小五混合代理）
# ============================================================
DEEPSEEK_API_KEY      = "sk-bcb39a7f68584135be65322d1a2ad546"
DEEPSEEK_BASE_URL     = "https://api.deepseek.com"
DEEPSEEK_MODEL        = "deepseek-chat"      # 使用 chat 模型（快速）
DEEPSEEK_SWITCH_MOVE  = 5                   # 前 N 手用 Minimax，之后调 API
DEEPSEEK_TEMPERATURE  = 0.85                 # 让猫娘更跳脱

# ── 猫娘小五 UI 配置 ──────────────────────────────────────
GUI_COLOR_REPLY_BG   = (28,  18,  38)       # 猫娘台词背景（深紫调）
GUI_COLOR_REPLY_TEXT = (255, 200, 240)      # 猫娘台词字体色（粉紫）

# ── 猫娘小五 TTS 语音配置 ─────────────────────────────────────
TTS_ENABLED = True                          # 是否开启语音朗读
TTS_VOICE   = "ja-JP-NanamiNeural"         # 微软 Neural 声线（少女声，活泼甜美）
TTS_RATE    = "+0%"                        # 语速（+快/-慢）
TTS_PITCH   = "+15Hz"                        # 音调（+高/-低）
